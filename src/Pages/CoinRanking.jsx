...
const CoinRanking = () => {
  useEffect(() => {
    document.title = "Coin Ranking | Nullion";
  });
        ...
        <div className="relative flex flex-col gap-12">
          ...
          <div className="grid items-center gap-12 md:grid-cols-2">
            ...
            <div className="flex flex-col gap-4">
              <h1 className="bg-gradient-five bg-cover bg-clip-text text-center text-3xl font-bold text-transparent md:text-left md:text-4xl">
                Founding and early days
              </h1>
              <div className="flex flex-col items-center gap-4 md:items-start">
                <p className="max-w-lg text-center md:max-w-2xl md:text-left">
                  Nullion was founded in 2010 by four people, two of them are
