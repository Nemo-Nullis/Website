...
const Pricing = () => {
  ...
  useEffect(() => {
    document.title = "Pricing | Nullion";
  });
  ...
  return (
    <div>
      <title>Pricing | Nullion</title>
      <main>
        <Container>
          <div className="flex flex-col gap-12">
            <div className="flex flex-col items-center gap-2">
              <h1 className="bg-gradient-five bg-cover bg-clip-text bg-center pb-1 text-4xl font-bold text-transparent lg:text-5xl">
                Our Pricing Plan
              </h1>
