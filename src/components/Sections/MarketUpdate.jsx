...
const MarketUpdate = () => {
  ...
  const url = `https://api.coingecko.com/api/v3/coins/markets?vs_currency=usd&order=market_cap_desc&per_page=25&page=${currentPage}&sparkline=false`;
    ...
    paginationButtons.push(
      <button
        ...
        className={mergeClasses(
          ...
          i === currentPage
            ? "bg-gradient-five bg-cover bg-center bg-no-repeat"
  ...
  return (
    <Container>
      <div className="flex w-full flex-col gap-8 md:gap-10">
        <h1 className="bg-gradient-five bg-cover bg-clip-text text-center text-4xl font-bold text-transparent lg:text-4xl">
          Nullion Market Update
        </h1>
        ...
        <div className="market-cap flex flex-col gap-3 overflow-x-scroll whitespace-nowrap">
          <div className="grid grid-cols-table place-items-center gap-8 whitespace-nowrap border-b-2 border-app-50 py-2">
            ...
            {/*<p className="font-medium text-app-50 md:text-lg">Ranking</p>*/}
            <p className="font-medium text-app-50 md:text-lg">Price</p>
            <p className="font-medium text-app-50 md:text-lg">Market Cap</p>
            <p className="font-medium text-app-50 md:text-lg">Trading Volume</p>
