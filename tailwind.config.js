  ...
  theme: {
    extend: {
      ...
      backgroundImage: {
        ...
        "gradient-four": "linear-gradient(179deg, rgb(248, 250, 252) 0%, rgba(248, 250, 252, 0.4) 100%)",
        "gradient-five": "linear-gradient(179deg, rgb(88, 191, 129) 0%, rgba(88, 191, 129, 0.4) 100%)",
      },
      backgroundPosition: {
        0: "0% 0%",
      },
